...
## Procedures
- **Select Random Dates**: When asked to choose random dates, click the "Starting date" button, pick a day at least 14 days in the future, then pick another day 3-7 days after that.
- **Perform Search**: After entering parameters, click the primary button in the booking widget (usually "Search Now").
